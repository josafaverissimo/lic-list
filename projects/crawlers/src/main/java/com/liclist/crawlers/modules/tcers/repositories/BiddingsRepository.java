...
public class BiddingsRepository {
    ...
    private final Logger logger = LoggerFactory.getLogger(BiddingsRepository.class);

    @Inject
    public BiddingsRepository(SessionFactory sessionFactory, BiddingSourceSeed biddingSourceSeed) {
    ...
    public Optional<Bidding> getBiddingByCode(String code) {
        return this.sessionFactory.fromTransaction(session -> {
            ...
            Bidding data = session.createSelectionQuery(query, Bidding.class)
    ...
    public Bidding create(BiddingDto biddingDto) {
        ...
        return this.sessionFactory.fromTransaction(session -> {
            ...
            logger.info(String.format("Bidding #(code=%s) has been created", biddingDto.code()));
    ...
    public Bidding getOrCreate(BiddingDto biddingDto) {
        return getBiddingByCode(biddingDto.code()).orElseGet(() -> this.create(biddingDto));
    }
}
